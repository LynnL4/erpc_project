...
// Core0Interface interface myFun function client shim.
void myFun(const callback1_t pCallback1_t)
{
    ...
    {
        codec->startWriteMessage(kOnewayMessage, kCore0Interface_service_id, kCore0Interface_myFun_id, request.getSequence());

        codec->writeCallback((funPtr)(callback1), (funPtr)(pCallback1_t));
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, kCore0Interface_myFun_id);

    return;
}

// Core0Interface interface callback1 function client shim.
void callback1(int32_t a, int32_t b)
{
    ...
    {
        codec->startWriteMessage(kOnewayMessage, kCore0Interface_service_id, kCore0Interface_callback1_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, kCore0Interface_callback1_id);
